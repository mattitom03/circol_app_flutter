  ...
  Future<void> _createTestProducts() async {
    final prodottiTest = [
      Product(
        ...
        ordinabile: true,
        numeroPezzi: 100,
        dataCreazione: DateTime.now().subtract(const Duration(days: 30)),
        dataAggiornamento: DateTime.now().subtract(const Duration(days: 1)),
      ),
      Product(
        id: '2',
        nome: 'Panino Club',
        ...
        ordinabile: true,
        numeroPezzi: 50,
        dataCreazione: DateTime.now().subtract(const Duration(days: 25)),
        dataAggiornamento: DateTime.now().subtract(const Duration(days: 2)),
      ),
      Product(
        id: '3',
        nome: 'Caffè Espresso',
        ...
        ordinabile: true,
        numeroPezzi: 200,
        dataCreazione: DateTime.now().subtract(const Duration(days: 60)),
      ...
      Product(
        ...
        ordinabile: true,
        numeroPezzi: 30,
        dataCreazione: DateTime.now().subtract(const Duration(days: 10)),
        dataAggiornamento: DateTime.now().subtract(const Duration(hours: 6)),
      ),
      Product(
        id: '5',
        nome: 'Birra Media',
        ...
        ordinabile: true,
        numeroPezzi: 150,
        dataCreazione: DateTime.now().subtract(const Duration(days: 40)),
        dataAggiornamento: DateTime.now().subtract(const Duration(hours: 12)),
      ),
    ];
