        ...
        child: Padding(
          ...
          child: Consumer<AuthViewModel>(
            builder: (context, authViewModel, child) {
              // Ascolta i cambiamenti per navigare o mostrare errori
              ...
              return Form(
                ...
                child: Column(
                  ...
                  children: [
                    const SizedBox(height: 20), // Spazio extra in cima
                    const Icon(
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (value.length < 6) return 'Password deve essere di almeno 6 caratteri';
                        return null;
                      },
